...
import com.manage.filter.JwtTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .successForwardUrl("/manage/login-success")
                .failureForwardUrl("/manage/login-failure")
                .and()
                .authorizeRequests()
                .antMatchers("/hello","/manage/register","/manage/logout","/manage/test","/manage/verify/*","/**").permitAll()//都可以访问
